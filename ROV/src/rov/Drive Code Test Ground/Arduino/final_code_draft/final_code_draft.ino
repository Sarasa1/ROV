...
void WriteOutValues()
{
  ...
  //  }
    Serial.print(editForSend(ypr[0], bytes));
    Serial.print(editForSend(ypr[1], bytes));
    Serial.print(editForSend(ypr[2], bytes));
    Serial.print(editForSend(aaReal.x, bytes));
    Serial.print(editForSend(aaReal.y, bytes));
    Serial.print(editForSend(aaReal.z, bytes));
    Serial.print(editForSend(sonarDistance, bytes));
    Serial.print(editForSend(pressure, bytes));
...
void LeapMove()
{
  ...
  clawDistance = constrain(clawDistance, 80, 175);
