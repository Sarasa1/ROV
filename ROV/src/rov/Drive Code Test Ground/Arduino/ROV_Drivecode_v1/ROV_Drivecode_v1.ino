...
int i;
int PWMPinLocation[] = {3,5,6,9,10,11};
int height = 0;
long RX, RY, LX, LY;
...
//  Wire.endTransmission(true);
  ...
  Serial.begin(14400);  //Baud here must match baud on c++ side
...
//  double GyZnew=Wire.read()<<8|Wire.read();  // 0x47 (GYRO_ZOUT_H) & 0x48 (GYRO_ZOUT_L)
//  double deltpos=(GyZnew+GyZ)*.005;
//  GyZ=GyZnew;
//  Zpos = Zpos + deltpos;
  delay(30);
}
